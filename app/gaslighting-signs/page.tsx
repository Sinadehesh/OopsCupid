...
export const metadata: Metadata = {
  ...
  description: "Everything you need to know about 10 signs of gaslighting and how to protect your peace.",
};
...
export default function ArticlePage() {
  return (
    <>
      <MainHero
        headline="10 Signs of Gaslighting"
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <article className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none">
            <p>This is a placeholder for the article. Here you will write the SEO optimized content discussing the psychological realities and practical signs related to <strong>10 Signs of Gaslighting</strong>.</p>
