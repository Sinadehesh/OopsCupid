...
export const TOXIC_FRIEND_QUESTIONS: Question[] = [
  // --- MODULE A: Friendship Victimization ---
  ...
  // --- MODULE B: Negative Friendship Quality ---
  ...
  // --- MODULE C: Relational Aggression ---
  ...
  // --- MODULE E: Antisocial / Unsafe Influence ---
  ...
  // --- MODULE F: Vulnerability & Resilience Inventory ---
  ...
  // --- MODULE G: Emotional Harm Impact ---
