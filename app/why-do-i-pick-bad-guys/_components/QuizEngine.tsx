...
export default function QuizEngine() {
  ...
  if (!started) {
    return (
      <div className="max-w-3xl mx-auto py-20 px-6 text-center animate-in fade-in duration-700">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-6 tracking-tight">Why Do I Pick Bad Guys?</h1>
  ...
  const progress = ((currentQ + 1) / BAD_GUYS_QUESTIONS.length) * 100;
  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-6">
      ...
      <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-xl border border-slate-100 text-center mb-8">
        <h2 className="text-2xl md:text-4xl font-extrabold text-slate-800 leading-tight">"{question.text}"</h2>
      </div>
