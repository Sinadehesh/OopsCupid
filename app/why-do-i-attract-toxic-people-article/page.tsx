...
export const metadata: Metadata = {
  title: "The Psychology of Toxic Attraction | OopsCupid Guide",
  description: "Everything you need to know about the psychology of toxic attraction and how to protect your peace.",
};
...
export default function ArticlePage() {
  return (
    <>
      <MainHero
        headline="The Psychology of Toxic Attraction"
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        <div className="mb-12 border-b border-border pb-8">
            <Link href="/attraction-patterns" className="text-primary-600 hover:text-primary-700 font-medium">
                &larr; Back to Attraction Patterns
            </Link>
        </div>
        <article className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none">
            <p>This is a placeholder for the article. Here you will write the SEO optimized content discussing the psychological realities and practical signs related to <strong>The Psychology of Toxic Attraction</strong>.</p>
