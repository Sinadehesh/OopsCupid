...
const senses = [
  {
    ...
    bgLight: 'bg-blue-50',
    tip: 'Look for small details you usually ignore. A shadow, a crack in the wall, the pattern on a book.',
  },
  {
    num: 4,
    ...
    tip: 'Actually reach out and touch them. Is it cold? Is it rough? Is it soft?',
  },
  {
    num: 3,
    ...
    bgLight: 'bg-amber-50',
    tip: 'Listen closely. The hum of a fridge? A car outside? Your own breath?',
  },
  {
    num: 2,
    ...
    bgLight: 'bg-rose-50',
    tip: "Your shirt? Coffee? If you can't smell anything, just take a deep sniff of the air.",
  },
  {
    num: 1,
    ...
    tip: 'Is there a lingering taste of toothpaste? Coffee? If not, just take a sip of water.',
  },
];

const whatIfCards = [
  {
    if: 'What if they are losing feelings for me right now?',
    is: 'Right now, I am safely sitting in my room, and no one is actively leaving me.',
  },
  {
    if: 'What if they find someone better and abandon me?',
    is: 'Right now, my feet are on the floor, and I am breathing in oxygen.',
  },
  {
    if: 'What if I am too needy and ruin everything?',
    is: 'Right now, I am simply having a feeling. A feeling is not a fact.',
  },
];
      ...
      <header className="relative overflow-hidden pt-20 pb-20 px-6">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-2xl leading-relaxed">
            When anxiety pulls you into a scary future, we use your 5 senses to pull you back to the safe present.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 space-y-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-2/3">
              ...
              <div className="space-y-4 text-base text-slate-600 leading-relaxed">
                <p>
                  Think of your brain as a time machine. When you feel secure, your brain lives in the <strong>present</strong>. You enjoy the moment.
                </p>
                <p>
                  But when your Anxious Attachment is triggered, your brain instantly jumps into a scary <strong>future</strong>. It starts asking terrifying questions: <em>What if they leave? What if I end up alone?</em>
                </p>
                <div className="bg-indigo-50/80 p-5 rounded-2xl border border-indigo-100 flex items-start gap-3 mt-4">
                  <Info className="w-5 h-5 text-indigo-500 shrink-0 mt-0.5" />
                  <p className="text-sm text-indigo-900 leading-relaxed">
                    <strong>The problem:</strong> your body doesn't know the future isn't real yet. If you <em>think</em> about being abandoned, your body can panic as if it is happening right this second.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="md:w-1/3 shrink-0">
              <img
                ...
                alt="Clock face blurring into the background"
                width={300}
                height={200}
                loading="lazy"
        ...
        <section className={CARD.replace('bg-white/70', 'bg-rose-50/60').replace('shadow-indigo-100/40', 'shadow-rose-100/40')}>
          ...
          <p className="text-slate-500 mb-8 text-base leading-relaxed">
            We stop time-traveling by changing <strong>What-Ifs</strong> into <strong>What-Is</strong>. Tap each card to drag your brain back to right now.
          </p>
              ...
              <button
                ...
                className={`w-full text-left p-6 rounded-2xl border-2 transition-all duration-300 ${
                  flippedCards[index]
                    ...
                    : 'bg-white/80 border-rose-200 hover:border-rose-400 shadow-sm'
                }`}
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="pr-8 flex-1">
                    <span className={`text-xs font-bold uppercase tracking-wider mb-2 block ${flippedCards[index] ? 'text-emerald-600' : 'text-rose-500'}`}>
                      {flippedCards[index] ? 'What IS (The Safe Present)' : 'What IF (The Scary Future)'}
                    </span>
                    <p className={`text-base font-medium leading-snug ${flippedCards[index] ? 'text-emerald-900' : 'text-slate-800'}`}>
                      {flippedCards[index] ? card.is : card.if}
                    </p>
                  </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center relative z-10">
            <div className="md:w-1/2">
              ...
              <p className="text-indigo-200 text-base leading-relaxed mb-6">
                Before the 5-4-3-2-1 exercise, we drop an anchor. When a boat is in a storm, the anchor holds it still. Your breath is your anchor.
              </p>
              ...
              <div className="bg-indigo-900/50 p-6 rounded-2xl border border-indigo-800 mb-6">
                ...
                <div className="mb-4">
                  <label className="flex justify-between text-sm text-indigo-100 mb-2">
                    <span>Inhale (Breathe in)</span>
                    <span className="font-bold">{inhaleTime} seconds</span>
                  </label>
                  <input
                    type="range"
                    min="2"
                    ...
                    className="w-full accent-indigo-400 disabled:opacity-50"
                  />
                </div>

                <div>
                  <label className="flex justify-between text-sm text-indigo-100 mb-2">
                    <span>Exhale (Blow out slowly)</span>
                    <span className="font-bold">{exhaleTime} seconds</span>
                  </label>
                  <input
                    type="range"
                    min="2"
                ...
                <p className="text-xs text-indigo-400 mt-4 text-center">
                  Tip: making your exhale longer than your inhale slows down your heart rate.
                </p>
              </div>
            </div>
            ...
            <div className="md:w-1/2 flex flex-col items-center justify-center w-full">
              <div className="relative w-48 h-48 flex items-center justify-center mb-8">
                <div
                  ...
                  style={{
                    ...
                    transitionDuration: bubbleDuration,
                  }}
                />
                <div
              ...
              <button
                ...
                className={`w-full max-w-xs py-4 rounded-full font-bold text-base transition-all flex items-center justify-center ${
                  isBreathing
        ...
        <section className={CARD}>
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="text-slate-600 text-base leading-relaxed">
              Now that your anchor is dropped, let's look around. Your brain thinks you are in danger. By forcing your brain to process boring, normal sensory data, you prove to your body that you are actually safe.
            </p>
          </div>
            ...
            {step < 5 ? (
              <div className="w-full max-w-xl mx-auto">
                <div className={`flex flex-col items-center mb-8 p-6 rounded-2xl ${senses[step].bgLight} border ${senses[step].border}`}>
                  <div className={`w-20 h-20 rounded-full ${senses[step].color} text-white flex items-center justify-center mb-4 shadow-lg`}>
                    {senses[step].icon}
                  </div>
                  <h3 className={`text-2xl md:text-3xl font-bold ${senses[step].text} mb-2 text-center`}>
                    Name {senses[step].num} {senses[step].sense}
                  </h3>
                ...
                <div className="space-y-4 mb-8">
                  <label className="block text-sm font-bold text-slate-500 uppercase tracking-wider pl-2">
                    Type what you notice right now:
                  </label>
                  <textarea
                    placeholder="I notice..."
                    className={`w-full bg-white border-2 ${senses[step].border} rounded-2xl p-5 outline-none text-slate-800 text-lg shadow-sm transition-shadow focus:shadow-md resize-none h-32`}
                    value={inputs[step]}
                    onChange={(e) => {
                ...
                <button
                  ...
                  className={`w-full py-5 ${senses[step].color} text-white font-bold text-lg rounded-2xl disabled:opacity-30 disabled:grayscale transition-all shadow-md hover:shadow-lg active:scale-[0.99]`}
                >
                  Confirm & Move to Next Sense
                </button>
              </div>
            ) : (
              <div className="text-center py-10">
                ...
                <p className="text-slate-600 text-xl max-w-md mx-auto mb-8 leading-relaxed">
                  Your thinking brain is back online. You are safe in the present moment.
                </p>
                ...
                <button
                  ...
                  className="mt-8 px-8 py-3 bg-slate-200 rounded-full text-slate-700 font-bold hover:bg-slate-300 transition-colors"
                >
                  Restart Practice
                </button>
              </div>
        ...
        <section className={CARD.replace('bg-white/70', 'bg-indigo-50/80')}>
          ...
          <p className="text-indigo-800 mb-4 text-base leading-relaxed">
            Finish this sentence to lock in the feeling of safety:
          </p>
          <div className="bg-white p-4 rounded-2xl border border-indigo-200 shadow-sm flex flex-col md:flex-row gap-4 items-center">
            ...
            <input
              type="text"
              className="flex-1 w-full outline-none text-lg text-slate-700 border-b border-dashed border-indigo-300 focus:border-indigo-600 pb-1 bg-transparent"
              placeholder="e.g. I am sitting in my room, breathing"
              value={reflection}
        ...
        <section className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-slate-200 gap-4">
          ...
          <a
            ...
            className="inline-flex items-center px-8 py-4 bg-slate-900 text-white font-bold rounded-full hover:bg-slate-800 transition-colors shadow-lg text-sm"
          >
            Continue to Day 4 <ArrowRight className="w-5 h-5 ml-2" />
          </a>
        </section>
      </main>
    </div>
