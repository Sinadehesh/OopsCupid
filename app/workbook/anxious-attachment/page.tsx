  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (timeLeft > 1) {
        ...
        const next: 'Inhale' | 'Exhale' = breathPhase === 'Inhale' ? 'Exhale' : 'Inhale';
        setBreathPhase(next);
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-2/3">
              <h2 className="text-2xl font-bold mb-4 flex items-center gap-3 text-slate-900">
                ...
                The &ldquo;Burnt Toast&rdquo; Metaphor
              </h2>
              <div className="space-y-4 text-base text-slate-600 leading-relaxed">
                <p>
                  ...
                  it blares the alarm &mdash; anxiety, racing heart &mdash; so you run.
                </p>
                <p>
                  With <strong>Anxious Attachment</strong>, your smoke detector is overly sensitive.
                  When your partner is quiet or pulls away, your brain reacts as if a tiger is in the
                  room. But there is no tiger. It&rsquo;s just burnt toast.
                </p>
              </div>
              <div className="mt-6 bg-rose-50/80 border border-rose-100 rounded-2xl p-5 flex items-start gap-3">
                ...
                <p className="text-sm text-rose-900 leading-relaxed">
                  ...
                  Telling yourself to &ldquo;calm down&rdquo; doesn&rsquo;t work. You must use your{' '}
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center relative z-10">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                ...
                Practice 2: Personalize Your Anchor
              </h2>
              <p className="text-slate-300 text-base leading-relaxed mb-6">
                Now manually turn off the alarm. Dial in your breathing pace below. The secret:{' '}
            ...
            <div className="md:w-1/2 flex flex-col items-center">
              <div className="relative w-48 h-48 flex items-center justify-center mb-8">
                ...
                >
                  ...
                  {isBreathing && (
                    <span className="text-3xl font-light mt-0.5 tabular-nums">{timeLeft}</span>
                  )}
                </div>
              </div>
              <button
