...
export default function HimHub() {
  return (
    <main className="min-h-screen bg-[#fafafa]">
      <section className="bg-[#3B82F6] text-white py-20 px-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link href="/is-he-manipulative" className="group block h-full">
            <div className="bg-white rounded-[32px] p-8 md:p-10 border border-[#0D2C54]/10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#3B82F6]/10 rounded-bl-full -z-0 transition-transform group-hover:scale-110"></div>
              <div className="w-14 h-14 bg-[#3B82F6] rounded-2xl flex items-center justify-center mb-8 shadow-md z-10">
              ...
              <div className="flex items-center text-[#3B82F6] font-extrabold z-10 mt-auto uppercase text-sm tracking-wide">
          ...
          <Link href="/is-he-gaslighting-me" className="group block h-full">
            <div className="bg-white rounded-[32px] p-8 md:p-10 border border-[#0D2C54]/10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#6366F1]/10 rounded-bl-full -z-0 transition-transform group-hover:scale-110"></div>
              <div className="w-14 h-14 bg-[#6366F1] rounded-2xl flex items-center justify-center mb-8 shadow-md z-10">
              ...
              <div className="flex items-center text-[#6366F1] font-extrabold z-10 mt-auto uppercase text-sm tracking-wide">
          ...
          <Link href="/partners-attachment-style" className="group block h-full">
            <div className="bg-white rounded-[32px] p-8 md:p-10 border border-[#0D2C54]/10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#0EA5E9]/10 rounded-bl-full -z-0 transition-transform group-hover:scale-110"></div>
              <div className="w-14 h-14 bg-[#0EA5E9] rounded-2xl flex items-center justify-center mb-8 shadow-md z-10">
              ...
              <div className="flex items-center text-[#0EA5E9] font-extrabold z-10 mt-auto uppercase text-sm tracking-wide">
          ...
          <Link href="/dating-texting-analysis" className="group block h-full">
            <div className="bg-white rounded-[32px] p-8 md:p-10 border border-[#0D2C54]/10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#14B8A6]/10 rounded-bl-full -z-0 transition-transform group-hover:scale-110"></div>
              <div className="w-14 h-14 bg-[#14B8A6] rounded-2xl flex items-center justify-center mb-8 shadow-md z-10">
              ...
              <div className="flex items-center text-[#14B8A6] font-extrabold z-10 mt-auto uppercase text-sm tracking-wide">
