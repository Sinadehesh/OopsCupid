...
export default function Home() {
  return (
    <main>
      ...
      <section className="bg-[#FDF6EE] py-20 md:py-32">
        <div className="container mx-auto px-6 md:px-10 lg:px-14">
          <h2 className="text-[32px] md:text-[42px] font-extrabold text-[#3B1F2B] mb-12 text-center md:text-left">
            Free Relationship Clarity Tools & Quizzes
          </h2>
          <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-start">
            <div className="flex-1">
              <p className="text-[18px] md:text-[22px] font-medium leading-relaxed text-[#3B1F2B]/80 mb-10 max-w-2xl">
              ...
              <Link href="/quizzes" className="inline-block bg-[#C73E1D] text-white rounded-full px-8 py-4 text-[18px] font-bold hover:bg-[#A83519] hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                Take a Free Quiz →
              </Link>
            </div>
            <div className="flex-1 w-full">
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  <span className="flex-shrink-0 flex items-center justify-center w-8 h-8 rounded-full bg-[#2E86AB]/20 text-[#2E86AB] font-extrabold">✓</span>
                  <span className="text-[18px] font-bold text-[#3B1F2B]">Free quizzes for red flags, friendships, and dating patterns</span>
                </li>
                <li className="flex items-start gap-4">
                  <span className="flex-shrink-0 flex items-center justify-center w-8 h-8 rounded-full bg-[#2E86AB]/20 text-[#2E86AB] font-extrabold">✓</span>
                  <span className="text-[18px] font-bold text-[#3B1F2B]">AI-powered chat and profile analyzers</span>
                </li>
                <li className="flex items-start gap-4">
                  <span className="flex-shrink-0 flex items-center justify-center w-8 h-8 rounded-full bg-[#2E86AB]/20 text-[#2E86AB] font-extrabold">✓</span>
                  <span className="text-[18px] font-bold text-[#3B1F2B]">Psychology-backed guides written for real situations</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="bg-white py-20 md:py-32">
        <div className="container mx-auto px-6 md:px-10 lg:px-14">
          <h2 className="text-[32px] md:text-[42px] font-extrabold text-[#3B1F2B] mb-12 text-center">
      ...
      <section className="bg-[#FDF6EE] py-20 md:py-32">
        <div className="container mx-auto px-6 md:px-10 lg:px-14">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-[32px] md:text-[42px] font-extrabold text-[#3B1F2B] mb-6">
              Free Relationship Quizzes
            </h2>
            <p className="text-[18px] md:text-[22px] font-medium leading-relaxed text-[#3B1F2B]/80">
              Answer a few questions and get a real, honest read on your situation. No sign-up. No fluff.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card variant="quiz" title="What Is My Attachment Style? Free Test" href="/attachment-style-quiz" accentColor="bg-[#F18F01]/30" />
            <Card variant="quiz" title="Is My Friend Toxic? Free Friendship Quiz" href="/toxic-friend-test" accentColor="bg-[#2E86AB]/20" />
            <Card variant="quiz" title="Why Do I Keep Attracting the Same Type?" href="/attraction-patterns" accentColor="bg-[#C73E1D]/20" />
          </div>
          
          <div className="text-center">
            <Link href="/quizzes" className="text-[18px] text-[#2E86AB] hover:text-[#3B1F2B] hover:underline underline-offset-4 font-bold transition-colors">
      ...
      <section className="bg-white py-20 md:py-32">
        <div className="container mx-auto px-6 md:px-10 lg:px-14">
          <h2 className="text-[32px] md:text-[42px] font-extrabold text-[#3B1F2B] mb-16 text-center">
      ...
      <section className="bg-[#FDF6EE] py-20 md:py-32">
        <div className="container mx-auto px-6 md:px-10 lg:px-14">
          ...
          <div className="text-center">
            <Link href="/articles" className="text-[18px] text-[#2E86AB] hover:text-[#3B1F2B] hover:underline underline-offset-4 font-bold transition-colors">
              Read all guides →
            </Link>
          </div>
        </div>
      ...
      <section className="bg-[#3B1F2B] py-24 text-white">
        <div className="container mx-auto px-6 md:px-10 lg:px-14">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-[18px] md:text-[20px] font-medium text-[#FDF6EE]/90 leading-relaxed max-w-xl mx-auto lg:mx-0">
            ...
            <div className="lg:w-1/2 w-full max-w-lg mx-auto lg:max-w-none lg:mx-0">
              <form className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="w-full bg-white text-[#3B1F2B] px-6 py-4 rounded-full focus:outline-none focus:ring-4 focus:ring-[#2E86AB]/50 text-[18px] font-medium placeholder:text-[#3B1F2B]/40"
                  required
                />
                <button 
                  type="submit"
                  className="w-full sm:w-auto bg-[#F18F01] text-[#3B1F2B] px-8 py-4 rounded-full font-extrabold text-[18px] hover:bg-[#D98100] transition-colors whitespace-nowrap shadow-lg"
                >
                  Subscribe Free
                </button>
              </form>
