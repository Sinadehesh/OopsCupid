...
export const metadata: Metadata = {
  title: "Love Bombing vs Genuine Affection | OopsCupid Guide",
  description: "Everything you need to know about love bombing vs genuine affection and how to protect your peace.",
};
...
export default function ArticlePage() {
  return (
    <>
      <MainHero
        headline="Love Bombing vs Genuine Affection"
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <article className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none">
            <p>This is a placeholder for the article. Here you will write the SEO optimized content discussing the psychological realities and practical signs related to <strong>Love Bombing vs Genuine Affection</strong>.</p>
