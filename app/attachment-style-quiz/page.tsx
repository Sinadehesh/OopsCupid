...
export default function MegaBatteryPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0496ff]/5 to-[#fcfcfc] pb-24 font-sans">
      
      {/* HERO SECTION */}
      <section className="relative bg-gradient-to-r from-[#006ba6] to-[#0496ff] pt-24 pb-40 px-6 md:px-10 lg:px-14 rounded-b-[3rem] text-white text-center shadow-lg">
        <div className="max-w-4xl mx-auto">
          <span className="text-[#ffbc42] font-bold uppercase tracking-widest text-sm mb-4 block drop-shadow-sm">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 md:px-8 -mt-24 relative z-10 mb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 lg:px-14">
        <div className="text-center mb-16">
          <h2 className="text-[32px] md:text-[42px] font-extrabold text-[#006ba6] mb-6">
            What This Test Measures
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          <div className="bg-white rounded-2xl shadow-sm border border-[#0496ff]/20 overflow-hidden flex flex-col hover:shadow-lg transition-all">
            <div className="bg-[#006ba6] text-white text-[13px] font-bold uppercase tracking-widest py-3 text-center">Phase 1: Attachment</div>
            <div className="p-8 flex justify-center items-center bg-[#0496ff]/5"><ShieldCheck className="w-20 h-20 text-[#006ba6] stroke-[1.5]" /></div>
            <div className="p-6 text-center flex-grow"><p className="text-[#334B63] text-[15px] leading-relaxed font-medium">Uses the 9-item ECR-RS structure to map your exact levels of attachment anxiety and avoidance.</p></div>
          </div>
          <div className="bg-white rounded-2xl shadow-sm border border-[#0496ff]/20 overflow-hidden flex flex-col hover:shadow-lg transition-all">
            ...
            <div className="p-6 text-center flex-grow"><p className="text-[#334B63] text-[15px] leading-relaxed font-medium">Uses the 10-item Rosenberg scale to determine your baseline self-worth and boundaries.</p></div>
          </div>
          <div className="bg-white rounded-2xl shadow-sm border border-[#0496ff]/20 overflow-hidden flex flex-col hover:shadow-lg transition-all">
            ...
            <div className="p-6 text-center flex-grow"><p className="text-[#334B63] text-[15px] leading-relaxed font-medium">Uses the 16-item DERS scale to measure how dysregulated your nervous system gets during stress.</p></div>
          </div>
          <div className="bg-white rounded-2xl shadow-sm border border-[#0496ff]/20 overflow-hidden flex flex-col hover:shadow-lg transition-all">
            ...
            <div className="p-8 flex justify-center items-center bg-[#ffbc42]/10"><Heart className="w-20 h-20 text-[#ffbc42] stroke-[1.5]" /></div>
            <div className="p-6 text-center flex-grow"><p className="text-[#334B63] text-[15px] leading-relaxed font-medium">Maps your approach to romance using Hendrick's typologies (Eros, Ludus, Pragma, etc).</p></div>
          </div>
        </div>
      </section>
    </main>
