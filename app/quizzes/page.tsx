...
export const metadata: Metadata = {
  title: "All Relationship & Dating Quizzes | OopsCupid",
  description: "Browse our collection of 7 free, psychology-backed relationship quizzes. Spot red flags, discover your attachment style, and decode mixed signals.",
};

export default function QuizzesHubPage() {
  return (
    <main className="bg-gradient-to-b from-[#FFF0ED] to-[#F9F4F4] min-h-screen py-24 px-6 md:px-10 lg:px-14">
      <div className="max-w-6xl mx-auto">
        
        {/* Hub Header with heavy pink aesthetic */}
        <div className="text-center max-w-3xl mx-auto mb-20 relative">
          <span className="text-[#FF69B4] font-bold uppercase tracking-widest text-sm mb-4 block drop-shadow-sm">
            Self-Discovery Hub
          </span>
          <h1 className="text-[42px] md:text-[56px] font-extrabold text-[#334B63] mb-6 leading-tight">
            Find Your <span className="text-[#FFB8A1] font-serif italic">Answers</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card 
            ...
            accentColor="bg-[#FF69B4]/30"
          />

          {/* Featured 7th Card - Centered and wider */}
          <div className="md:col-span-2 lg:col-span-3 lg:w-2/3 mx-auto w-full mt-4">
              <Card 
                variant="quiz"
                title="Is He Cheating? The Micro-Cheating Test"
                href="/is-he-cheating"
                accentColor="bg-gradient-to-r from-[#FFB8A1]/50 to-[#FF69B4]/30"
              />
          </div>
