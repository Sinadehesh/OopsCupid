...
export default function MasterReport({ profile, demographics, isDarkTheme = false }: MasterReportProps) {
  ...
  return (
    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      ...
      {/* HERO SECTION & QUADRANT (Side-by-side on PC) */}
      ...
      <div className="space-y-12 md:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          <div className={`rounded-3xl border p-6 md:p-8 flex flex-col h-full ${cardClass}`}>
        ...
        {/* CAREGIVERS */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch pt-8">
          <div className="flex flex-col gap-6 md:gap-8 h-full">
            <div className={`rounded-3xl border p-6 md:p-8 flex-1 ${cardClass}`}>
        ...
        <h3 className={`text-2xl md:text-3xl font-extrabold ${tH3} mt-16 border-t ${isDarkTheme ? 'border-slate-800' : 'border-slate-200'} pt-12 mb-2`}>
          Core Psychological Drivers
        </h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch mb-12">
          <div className="flex flex-col gap-6 md:gap-8 h-full">
            <div className={`rounded-3xl border p-6 md:p-8 flex-col ${cardClass}`}>
