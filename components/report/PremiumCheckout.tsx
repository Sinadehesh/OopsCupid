...
export default function PremiumCheckout({ onUnlock, isGenerating, archetype, relationshipStatus }: PremiumCheckoutProps) {
  ...
  return (
    <div className={`relative p-1 bg-white border border-[#d6d2d2] rounded-3xl shadow-lg mt-12`}>
      
      <div className="bg-[#f0c808] text-[#086788] text-center py-3 rounded-t-3xl flex items-center justify-center gap-2 font-black text-sm tracking-wide">
        <Clock className="w-4 h-4" /> 
        AI Server Allocation Secured For The Next 15 Minutes
      </div>

      <div className={`relative z-10 rounded-b-3xl overflow-hidden max-w-4xl mx-auto bg-white`}>
        <div className="p-8 md:p-12 text-center border-b border-[#d6d2d2]">
          <span className="inline-block py-1.5 px-4 rounded-full bg-[#fff1d0] text-[#086788] font-black text-sm tracking-widest uppercase mb-4 border border-[#f0c808]/50">
        ...
        <div className="p-8 md:p-12 grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className={`flex gap-5 p-6 rounded-2xl bg-white border border-[#d6d2d2] shadow-sm`}>
              <div className="shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-[#fff1d0] text-[#f686bd] border border-[#f686bd]/30"><BrainCircuit className="w-6 h-6" /></div>
              <div>
            ...
            <div className={`flex gap-5 p-6 rounded-2xl bg-white border border-[#d6d2d2] shadow-sm`}>
              <div className="shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-[#fff1d0] text-[#06aed5] border border-[#06aed5]/30"><HeartHandshake className="w-6 h-6" /></div>
              <div>
                <div className="flex justify-between items-start mb-1">
            ...
            <div className={`flex gap-5 p-6 rounded-2xl bg-white border border-[#f0c808] shadow-md relative overflow-hidden`}>
              ...
              <div className="shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-[#f0c808]/20 text-[#f0c808]"><Zap className="w-6 h-6 fill-current" /></div>
              <div>
                <div className="flex justify-between items-start mb-1">
          ...
          <div className="lg:col-span-2 flex flex-col justify-center">
            {/* The Price Box - Dark Anchor */}
            <div className={`p-8 rounded-3xl bg-[#086788] text-center shadow-lg relative`}>
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#f0c808] text-[#086788] text-xs font-black uppercase tracking-widest px-4 py-1.5 rounded-full whitespace-nowrap shadow-sm">
                Save 94% Today
              </div>
              
              <div className="space-y-1 mb-8 mt-4">
                <p className="text-sm font-bold text-white/60">Therapy: <span className="line-through">$1,200+ & 6 Months</span></p>
                <p className="text-sm font-bold text-white/60">Total Value: <span className="line-through">$341</span></p>
                <div className="flex items-baseline justify-center gap-2 pt-4">
                  <span className={`text-2xl font-black text-white`}>Today:</span>
                  <span className="text-7xl font-black text-[#06aed5]">$19</span>
                </div>
              </div>
              ...
              <button 
                ...
                className="w-full py-5 bg-[#dd1c1a] hover:bg-[#b10f2e] text-white rounded-2xl font-black text-xl transition-all shadow-md hover:-translate-y-1 flex items-center justify-center gap-3 disabled:opacity-80 disabled:hover:translate-y-0 cursor-pointer group"
              >
                {isGenerating ? (
        ...
        <div className={`p-6 border-t border-[#d6d2d2] bg-[#fff1d0]/30`}>
          <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            <div className="w-16 h-16 shrink-0 bg-white border border-[#d6d2d2] rounded-full flex items-center justify-center">
