...
export default function AttachmentReport({ profile, demographics, isDarkTheme = false }: AttachmentReportProps) {
  ...
  return (
    // BREAKOUT CONTAINER
    <div className={`w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] ${isDarkTheme ? 'bg-[#0f172a]' : 'bg-[#fcfcfc]'} py-12 md:py-20 mt-12 border-t ${isDarkTheme ? 'border-slate-800' : 'border-slate-200'}`}>
      
      <div className="max-w-6xl mx-auto px-4 md:px-8 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16 md:mb-24">
          ...
          <div className="flex flex-col justify-center order-1">
            <div className={`inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-extrabold tracking-wider uppercase mb-6 w-fit shadow-sm border ${isDarkTheme ? 'bg-blue-500/10 border-blue-500/20 text-blue-400' : 'bg-blue-50 border-blue-100 text-blue-700'}`}>
              <ShieldCheck className="w-4 h-4" />
              Trusted by Millions Worldwide
            </div>
            
            <h2 className={`text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 leading-tight ${tH3}`}>
              Your Complete Attachment Profile
            </h2>
          ...
          {/* Right Quadrant */}
          <div className="order-2 flex flex-col w-full">
            <h3 className={`text-xl md:text-2xl font-extrabold text-center mb-6 ${tH3}`}>Your Attachment Map</h3>
        ...
        <div className="space-y-12 md:space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            <div className={`rounded-3xl border p-8 flex flex-col h-full ${cardClass}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch pt-8">
            <div className="flex flex-col gap-8 h-full">
              <div className={`rounded-3xl border p-8 flex-1 ${cardClass}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch pt-12 border-t border-slate-200">
            <div className="flex flex-col gap-8 h-full">
              <div className={`rounded-3xl border p-8 flex-col ${cardClass}`}>
