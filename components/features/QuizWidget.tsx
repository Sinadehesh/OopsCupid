...
const ecrQ: Question[] = [
  { id: "ecr_general_1", section: "ecr", subscale: "General", text: "I find it easy to turn to people I am close to for emotional support.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_2", section: "ecr", subscale: "General", text: "I naturally discuss my problems with close friends.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_3", section: "ecr", subscale: "General", text: "I feel completely comfortable depending on others.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_4", section: "ecr", subscale: "General", text: "I enjoy talking things over and sharing my inner world.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_5", section: "ecr", subscale: "General", text: "I feel highly uncomfortable opening up emotionally to others.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_6", section: "ecr", subscale: "General", text: "I prefer to keep my deepest feelings to myself.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_7", section: "ecr", subscale: "General", text: "I frequently worry that people do not truly care about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_8", section: "ecr", subscale: "General", text: "I have an intense fear that close ones will abandon me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_general_9", section: "ecr", subscale: "General", text: "I constantly worry that I care about others more than they care about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_1", section: "ecr", subscale: "Romantic", text: "I find it easy to depend on romantic partners.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_2", section: "ecr", subscale: "Romantic", text: "I naturally discuss my problems with romantic partners.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_3", section: "ecr", subscale: "Romantic", text: "I feel completely comfortable depending on romantic partners.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_4", section: "ecr", subscale: "Romantic", text: "I enjoy sharing my inner world with partners.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_5", section: "ecr", subscale: "Romantic", text: "I feel uncomfortable opening up emotionally to partners.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_6", section: "ecr", subscale: "Romantic", text: "I prefer to keep my deepest feelings to myself in romance.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_7", section: "ecr", subscale: "Romantic", text: "I frequently worry that romantic partners do not truly care.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_8", section: "ecr", subscale: "Romantic", text: "I fear that romantic partners will eventually abandon me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_romantic_9", section: "ecr", subscale: "Romantic", text: "I worry I care about partners more than they care about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_1", section: "ecr", subscale: "Mother", text: "I found it easy to turn to my mother for emotional support.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_2", section: "ecr", subscale: "Mother", text: "I naturally discussed problems with my mother.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_3", section: "ecr", subscale: "Mother", text: "I felt comfortable depending on her.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_4", section: "ecr", subscale: "Mother", text: "I enjoyed sharing my inner world with her.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_5", section: "ecr", subscale: "Mother", text: "I felt uncomfortable opening up to her.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_6", section: "ecr", subscale: "Mother", text: "I preferred to keep my feelings to myself around her.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_7", section: "ecr", subscale: "Mother", text: "I worried she did not truly care about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_8", section: "ecr", subscale: "Mother", text: "I feared she would abandon me emotionally.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_mother_9", section: "ecr", subscale: "Mother", text: "I worried I cared more about her than she cared about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_1", section: "ecr", subscale: "Father", text: "I found it easy to turn to my father for emotional support.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_2", section: "ecr", subscale: "Father", text: "I naturally discussed problems with my father.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_3", section: "ecr", subscale: "Father", text: "I felt comfortable depending on him.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_4", section: "ecr", subscale: "Father", text: "I enjoyed sharing my inner world with him.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_5", section: "ecr", subscale: "Father", text: "I felt uncomfortable opening up to him.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_6", section: "ecr", subscale: "Father", text: "I preferred to keep my feelings to myself around him.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_7", section: "ecr", subscale: "Father", text: "I worried he did not truly care about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_8", section: "ecr", subscale: "Father", text: "I feared he would abandon me emotionally.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_father_9", section: "ecr", subscale: "Father", text: "I worried I cared more about him than he cared about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_1", section: "ecr", subscale: "Work", text: "I find it easy to depend on coworkers.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_2", section: "ecr", subscale: "Work", text: "I discuss problems with colleagues.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_3", section: "ecr", subscale: "Work", text: "I feel comfortable depending on teammates.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_4", section: "ecr", subscale: "Work", text: "I enjoy sharing my inner world at work.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_5", section: "ecr", subscale: "Work", text: "I feel uncomfortable opening up emotionally at work.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_6", section: "ecr", subscale: "Work", text: "I keep my deepest feelings to myself professionally.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_7", section: "ecr", subscale: "Work", text: "I worry coworkers do not truly care about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_8", section: "ecr", subscale: "Work", text: "I fear being abandoned by my team.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
  { id: "ecr_work_9", section: "ecr", subscale: "Work", text: "I worry I care more about the team than they care about me.", options: ["1 - Strongly Disagree", "2", "3", "4", "5", "6", "7 - Strongly Agree"] },
];
const rsQ: Question[] = [
          ...
          {q.options.map((option: string, idx: number) => {
            ...
            return (
              <button 
                ...
                disabled={isDisabled}
                className={`
                  w-[30%] min-w-[100px] flex-grow text-center flex-col justify-center py-3 px-4 md:py-4 md:px-5 rounded-[12px] border-[2px] font-bold text-sm md:text-base transition-all duration-200 flex items-center
