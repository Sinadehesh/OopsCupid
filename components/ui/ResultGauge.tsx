...
export default function ResultGauge({ score, label, subLabel, size = 'normal' }: ResultGaugeProps) {
  ...
  return (
    <div className={`flex flex-col items-center justify-between bg-[#000000] ${padding} rounded-[24px] shadow-2xl w-full border border-gray-800 h-full`}>
      <span className={`text-white font-extrabold ${labelSize} tracking-[0.1em] uppercase sans-serif block mb-4 text-center leading-tight min-h-[36px]`}>
         {label}
      </span>
