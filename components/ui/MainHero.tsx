    ...
    <section className="relative overflow-hidden bg-white pt-12 md:pt-16 lg:pt-20 pb-16 md:pb-20">
      <div className="relative z-10 mx-auto max-w-[1500px] px-4 sm:px-6 md:px-10 lg:px-14">
        ...
        <div className="mx-auto max-w-4xl text-center mb-10 md:mb-14">
          {topSubheading && (
            <p className="mb-4 text-sm md:text-base font-extrabold tracking-[0.2em] text-[#C73E1D]">
              {topSubheading}
            </p>
          )}
          <h1 className="text-[38px] leading-[1.1] tracking-tight font-extrabold text-[#3B1F2B] sm:text-[46px] md:text-[56px] lg:text-[64px]">
            {headline}
          </h1>
          {displayQuestion && (
            <p className="mx-auto mt-6 max-w-[700px] text-[18px] md:text-[20px] font-medium leading-[1.6] text-[#3B1F2B]/70">
              {displayQuestion}
            </p>
          )}
        </div>
      ...
      {/* WAVE DIVIDER CONNECTING TO THE SOFT BACKGROUND BELOW */}
      <div className="absolute bottom-0 left-0 w-full z-0 h-[40px] md:h-[80px]">
        <svg viewBox="0 0 1440 100" preserveAspectRatio="none" className="block h-full w-full" aria-hidden="true">
          <path fill="#FDF6EE" d="M0,100 L1440,100 L1440,80 C1160,20 920,0 720,40 C520,80 280,20 0,60 Z" />
        </svg>
      </div>
    </section>
  );
